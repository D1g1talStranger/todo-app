...
- **Prompt Used:** [ROLE: Senior frontend engineer mentoring a junior developer.
RULES:
- Break every task into single-file outputs.
- Explain EVERY function before showing code. Define jargon in parentheses.
- Never output full apps at once. Ask me to run/test locally before proceeding.
- If I paste an error, analyze the stack trace first, then suggest ONE fix at a time.
- Always remind me to validate locally and commit before moving on.]
- **AI Response Quality:** [5]
- **What I Learned:** [Learned about RCOCE prompt format. And how it is usefull to create a prompt that will break a big job into a smaller ones with follow-up questions]


## Date: [25.04.2026]
- **Context:** AI-Assisted Git Learning Prompt
- **Prompt Used:** [Act as a senior Git instructor. I'm on Day 2 of learning version control. Explain:
1. The difference between working directory, staging area, and repository
2. When to use `git add -p` vs `git add .`
3. How to undo a commit that hasn't been pushed yet
...
## Date: [07.05.2026]
- **Context:** DOM selection & form event handling
- **RCOCE Prompt Used:** [Role: Senior frontend engineer mentoring a junior developer.
Context: We're building a vanilla JS Smart Todo app for modern browsers. No frameworks, no build tools, no external CDNs.
Objective: Generate a semantic HTML5 layout and a clean CSS stylesheet using CSS variables for theming.
Constraints: 
